...
- ✍️ **写文章**: 往 `src/content/posts/<类别>/` 丢一个 `.md` 即可
...
```bash
./new_post.sh rust_learn day-3-structs "Day 3 · 结构体"
# ... 编辑 src/content/posts/rust_learn/day-3-structs.md,写完删掉 draft: true ...
./sync.sh "post: day 3 structs"        # 发布,~1 分钟上线
```
...
---
title: Day 3 · 结构体
pubDate: 2026-08-04 # 注意是 pubDate 不是 publishedAt
author: Roddy
description: 一句话摘要 # 注意是 description 不是 summary
categories: [rust_learn] # 数组;与所在文件夹保持一致
